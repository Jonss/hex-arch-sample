...
// NewRedisRepository creates a Redis repository
func NewRedisRepository(rediURL string) (shortener.RedirectRepository, error) {
	repo := &redisRepository{}
	client, err := newRedisClient(rediURL)
	if err != nil {
